...
const MailIcon = ({ className = "w-10 h-10 text-blue-500" }: { className?: string }) => ( // Añadido tipo para props
  <svg className={className} fill="#847AD5" stroke="#847AD5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="p-4 sm:p-6 md:p-8 min-h-screen">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 md:gap-6">
        ...
        <InfoCard
          ...
          buttonText="Iniciar"
          onButtonClick={() => handleOpenDataExtractForm("Pedido de Documentos")}
        />
        <InfoCard
          icon={<MailIcon />}
